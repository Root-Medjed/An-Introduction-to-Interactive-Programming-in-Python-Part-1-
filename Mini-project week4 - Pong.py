...
def draw(canvas):
    ...
    # update ball
    ball_pos[0] += ball_vel[0] / 50
    ball_pos[1] += ball_vel[1] / 50
    ...
    if HALF_PAD_HEIGHT <= paddle1_pos <= (HEIGHT - HALF_PAD_HEIGHT):
        ...
        elif (HEIGHT - HALF_PAD_HEIGHT) < (paddle1_pos + paddle1_vel):
    ...
    if HALF_PAD_HEIGHT <= paddle2_pos <= (HEIGHT - HALF_PAD_HEIGHT):
        ...
        elif (HEIGHT - HALF_PAD_HEIGHT) < (paddle2_pos + paddle2_vel):
    ...
    # draw scores
    canvas.draw_text(str(score1), [235, 60], 50, 'White')
    canvas.draw_text(str(score2), [320, 60], 50, 'White')
